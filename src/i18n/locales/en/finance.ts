const finance = {
  ...
  history: {
    ...
    emptyHint: 'Add your first transaction with the + button below',
    deleteTitle: 'Delete Transaction',
    deleteMessage: 'Are you sure you want to delete this transaction?',
    uncategorized: 'Uncategorized',
    // Interpolations avoid the name `count`: i18next treats it as a plural selector and looks up plural keys.
    resultCount: '{{total}} results',
    loadedOf: 'showing {{loaded}}',
    loadMore: 'Load more',
    searchAllTime: 'Search all months',
    filters: {
      title: 'Filters',
      range: 'Period',
      ...
      categoryRollupHint: 'Picking a main category also covers its subcategories.',
      apply: 'Apply',
      reset: 'Reset',
      clearAll: 'Clear',
    },
  ...
  addTransaction: {
    ...
    missingCategory: 'Pick a category to save',
    missingAmount: 'Enter an amount to save',
    missingCategoryAndAmount: 'Pick a category and enter an amount',
  },
  recurring: {
    ...
    forwardOnlyHint: 'Changes apply from next month on — transactions already created keep their current values.',
