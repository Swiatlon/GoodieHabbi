...
import QuestItemDateMonthly from './quest-item-date-monthly';
import QuestItemDateWeekly from './quest-item-date.weekly';
import { IRepeatableQuest } from '@/contract/quest';

interface RepatableQuestItemProps {
  quest: IRepeatableQuest;
  setQuests: React.Dispatch<React.SetStateAction<IRepeatableQuest[]>>;
}

const RepatableQuestItem: React.FC<RepatableQuestItemProps> = ({ quest, setQuests }) => {
          ...
          <TouchableOpacity onPress={openModal} className="flex-1">
            <View className="flex-row items-center gap-2">
              ...
              <View className="flex-1 gap-2">
                ...
                <QuestItemDateMonthly
                  startDay={quest.repeatDateRange?.startDay}
                  endDay={quest.repeatDateRange?.endDay}
                />
                <QuestItemDateWeekly repeatDaysOfWeek={quest.repeatDaysOfWeek} />
...
export default RepatableQuestItem;
