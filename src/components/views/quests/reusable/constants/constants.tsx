  ...
  Status: new Map([
    [
      'ALL',
      {
        ...
        labelKey: 'quests.reusable.filters.status.all',
        color: '#1987EE',
      },
    ],
    [
      'COMPLETED',
      {
        ...
        labelKey: 'quests.reusable.filters.status.completed',
        color: '#4caf50',
      },
    ],
    [
      'INCOMPLETED',
      {
        ...
        labelKey: 'quests.reusable.filters.status.incomplete',
        color: '#ffc107',
      },
    ],
  ]),
  ...
  Priority: new Map([
    [
      'LOW_PRIORITY',
      {
        ...
        labelKey: 'quests.reusable.filters.priority.low',
        color: '#4caf50',
      },
    ],
    [
      'MEDIUM_PRIORITY',
      {
        ...
        labelKey: 'quests.reusable.filters.priority.medium',
        color: '#ff9800',
      },
    ],
    [
      'HIGH_PRIORITY',
      {
        ...
        labelKey: 'quests.reusable.filters.priority.high',
        color: '#f44336',
      },
    ],
  ]),
