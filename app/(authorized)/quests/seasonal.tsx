...
const SeasonalQuests: React.FC = () => {
  ...
  if (isLoading) {
    return <Loader message={t('quests.seasonal.fetchingQuests')} />;
  }
    ...
    <>
      <View className="flex-1 p-4">
        ...
        <FlatList
          ...
          ListEmptyComponent={<Text className="text-center text-gray-500">{t('quests.seasonal.noQuestsFound')}</Text>}
        />

        <Animated.View style={buttonsStyle}>
          <Button
            label={t('quests.seasonal.addNewQuest')}
